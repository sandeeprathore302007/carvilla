<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewCars.aspx.cs" Inherits="CarVilla_Ecommerce_Project.NewCars" %>
								...
								<div class="row">
									...
									<div class="col-md-5 col-sm-12">
										<div class="new-cars-txt">
											...
											<button class="welcome-btn new-cars-btn" onclick="window.location.href='Payment.aspx'">
												Paynow
											</button>
										</div><!--/.new-cars-txt-->	
									</div><!--/.col-->
						...
						<div class="new-cars-item">
							<div class="single-new-cars-item">
								<div class="row">
									...
									<div class="col-md-5 col-sm-12">
										<div class="new-cars-txt">
											<h2><a href="#">Aston Martin Valkyrie</a></h2>
											<p>
												Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. 
											</p>
											<p class="new-cars-para2">
						...
						<div class="new-cars-item">
							<div class="single-new-cars-item">
								<div class="row">
									<div class="col-md-7 col-sm-12">
										<div class="new-cars-img">
											<img src="assets/images/new-cars-model/ncm6.png" alt="img"/>
										</div><!--/.new-cars-img-->
									</div>
									<div class="col-md-5 col-sm-12">
										<div class="new-cars-txt">
